...
-  🎯 [General Concepts](pages/ds_general.md):
 ...
 - 🧠 [Deep Learning](./page/deep_learning.md): it is a subfield of machine learning where neural networks with many layers ("deep") are trained to learn intricate patterns in data and to accomplish complex tasks accurately with minimal human intervention. Deep learning has significantly transformed fields like computer vision, natural language processing, and reinforcement learning.
